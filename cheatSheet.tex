...
\section{User Settings \& Repo creation}
    ...
    \columnbreak
        ...
        \begin{gitBaseCard}{Creating Repository}
            \begin{gitsection}{...}
                \gitCommandLong{git clone <url>}{Download an existing repository into a sub-directory}
                \gitCommandLong{git clone <url> .}{Download an existing repository into your current directory}
            \end{gitsection}
